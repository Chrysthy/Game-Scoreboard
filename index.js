  ...
  listaDeJogadores.forEach((jogador, index) => {
    ...
    elementoTabela.innerHTML += `
        <tr>
            ...
            <td><button onClick="adicionarVitoria(${index})">Victory</button></td>
            <td><button onClick="adicionarEmpate(${index})">Draw</button></td>
            <td><button onClick="adicionarDerrota(${index})">Defeat</button></td>
            <td><button onClick="limparPontuacaoJogador(${index})">Clear Records</button></td>
            <td><button onClick="removerJogador(${index})">Remove Player</button></td>
          </tr>
    `;
  });
}
